...
namespace MainExecParser
{
    public class Options
    {
        ...
        [Option('o', "output_dict_file", Required = false, Default = "[Smash][Ultimate][Main]All.dic", HelpText = "Ouput dictionary")]
        public string OutputDictFile { get; set; }
        [Option('l', "output_dict_lowerc_file", Required = false, Default = "[Smash][Ultimate][Main]All_lowercase.dic", HelpText = "Ouput dictionary")]
        ...
        [Option('p', "param_labels_file", Required = false, Default = "ParamLabels.csv", HelpText = "Input ParamLabel")]

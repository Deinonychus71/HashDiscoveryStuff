...
namespace BruteForceLastWordResearch
{
    public class Options
    {
        ...
        [Option('a', "accepted_types", Required = false, Default = "byte,float,int,sbyte,short,uint,ushort,string,hash40,bool", HelpText = "Accepted types, comma separated, if using input_uncracked_hashes_grouped")]
